...
export const Header: React.FC = () => {
  ...
  return (
    <header className="sticky top-0 z-50 w-full border-b border-cyan-200 dark:border-cyan-900 bg-white dark:bg-gray-900 shadow-sm transition-colors duration-300">
      <div className="container mx-auto px-4 py-4">
        ...
        {/* Mobile Navigation */}
        {isMenuOpen && (
          <nav className="md:hidden mt-4 pb-4 flex flex-col gap-2 border-t border-cyan-200 dark:border-cyan-900 pt-4">
            {NAV_ITEMS.map((item) => (
              <Link
                key={item.path}
                to={item.path}
